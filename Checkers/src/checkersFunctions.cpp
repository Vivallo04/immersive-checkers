...
std::string getSqInBetween(sq::Square *initSq, sq::Square *targetSq)
{
    ...
    std::string notptr_Square = initSq->square();
    std::string notptr_Square2 = targetSq->square();
	captureDirection = getCapDirection(&notptr_Square, &notptr_Square2);
...
bool isCapture() {
    ...
    std::string initializedSquare = squares[selected].square();
    std::string targetedSquare = squares[targeted].square();
	captureDirection = getCapDirection(&initializedSquare, &targetedSquare);
