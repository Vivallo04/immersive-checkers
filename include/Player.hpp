...
class Player
{// This class permits to create a generic player, which will be inherited by the HumanPlayer and the AIPlayer classes
public:
...
protected:
    ...
    void
    movePiece(std::vector<std::vector<int>> &, std::vector<Piece>, int, int, int);// This method permits to move a piece
